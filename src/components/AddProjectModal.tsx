                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <h4 className="font-bold text-gray-800">{t('modal.rice')}</h4>
                    ...
                    >
                      ...
                      <h4 className="font-bold text-gray-800">{t('modal.agroforestry')}</h4>
                      <p className="text-sm text-gray-600">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full p-4 border-2 border-gray-200 rounded-xl focus:border-green-500 focus:outline-none text-lg transition-colors pr-16"
                      placeholder="2.5"
                    />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full p-4 border-2 border-gray-200 rounded-xl focus:border-green-500 focus:outline-none text-lg h-24 resize-none transition-colors"
            ...
            {currentStep === 3 && (
              <div className="space-y-6">
                <div className="text-center">
                  <h3 className="text-xl font-bold text-gray-800 mb-2">{t('modal.photos')}</h3>
