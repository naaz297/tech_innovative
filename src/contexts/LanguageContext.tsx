...
const translations = {
  ...
  or: {
    ...
    'nav.preferences': 'ସେଟିଂସ',
    'nav.signout': 'ସାଇନ ଆଉଟ',
    'nav.darkmode': 'ଡାର୍କ ମୋଡ',
